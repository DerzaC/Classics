...
public class Block {
	...
	public void initField() {
		this.field = Controller.getCurrentGame().getField();
	}

	private void getXYPos() {
		this.xPos = Controller.getCurrentGame().getXPos();
		this.yPos = Controller.getCurrentGame().getYPos();
	}
	...
	public void killCounter() {  //Extend/override
		if (pulsecount >=getMaxTTL()+commonTTL) {isActive = false;
			if (Controller.getCurrentGame().getCurrentGame()=="snake") {
				selfDestruct();
			}
		}
	}
